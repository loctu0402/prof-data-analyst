---
description: Professional Data Analyst — process mode. Raw data → ML-ready features (DuckDB DWH-first, M1-M5 milestones, ExecSum table).
---

Invoke the `prof-data-analyst` skill in **process mode**. Read these references before acting:
1. `references/mode-process.md` — DWH-first architecture, progressive milestones, ExecSum block, univariate/bivariate split
...
User's process / ML-case request: $ARGUMENTS
